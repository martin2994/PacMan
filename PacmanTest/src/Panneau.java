	...
	public void paintComponent(Graphics g) {
		...
		for (int i=0;i<19;i++){
			for (int j=0;j<22;j++){
					...
					case 5:g.drawImage(img5, i*28, j*28, this);break;
					case 6:g.drawImage(img6, i*28, j*28, this);break;
					case 7:g.drawImage(img7, i*28, j*28, this) ;break;
					case 8:g.drawImage(img8, i*28, j*28, this); break;
					case 9:g.drawImage(img9, i*28, j*28, this);break;
					case 10:g.drawImage(img10, i*28, j*28, this);break;
					case 11:g.drawImage(img11, i*28, j*28, this); break;
					case 12:g.drawImage(img12, i*28, j*28, this); break;
					case 13:g.drawImage(img13, i*28, j*28, this); break;
					case 14:g.drawImage(img14, i*28, j*28, this);break;
					case 15:g.drawImage(img15, i*28, j*28, this);break;
					case 16:g.drawImage(img16, i*28, j*28, this);break;
					case 17:g.drawImage(img17, i*28, j*28, this) ;break;
					case 18:g.drawImage(img18, i*28, j*28, this); break;
					case 19:g.drawImage(img19, i*28, j*28, this);break;
					case 20:g.drawImage(img20, i*28, j*28, this);break;
		...
		if (form_pacman || timer_anim_pacman<10){
			switch (go_pacman){
				case UP:g.drawImage(pacman_up,posX,posY,this);break;
				case DOWN:g.drawImage(pacman_down,posX,posY,this);break;
				case LEFT:g.drawImage(pacman_left,posX,posY,this);break;
				case RIGHT:g.drawImage(pacman_right,posX,posY,this);break;
			}
			if (timer_anim_pacman ==9) form_pacman=false;
		}else{
